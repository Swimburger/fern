...
class DummyClient
{
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "generate-stream", method: HttpMethod::POST, body: $request));
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "generate", method: HttpMethod::POST, body: $request));
            $statusCode = $response->getStatusCode();

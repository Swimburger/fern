...
class PathParamClient
{
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "path/$$operand/$$maybeOperand/$$operandOrColor/$$maybeOperandOrColor", method: HttpMethod::POST));

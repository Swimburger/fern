...
class PlaylistClient
{
    ...
    * Create a new playlist
    ...
    public function createPlaylist(int $serviceParam, CreatePlaylistRequest $request, ?array $options = null): mixed
    {
        ...
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/v2/playlist/$$serviceParam/create", method: HttpMethod::POST, query: $query, body: $request->body));
    ...
    * Returns the user's playlists
    ...
    public function getPlaylists(int $serviceParam, GetPlaylistsRequest $request, ?array $options = null): mixed
    {
        ...
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/v2/playlist/$$serviceParam/all", method: HttpMethod::GET, query: $query));
            $statusCode = $response->getStatusCode();
            if ($statusCode >= 200 && $statusCode < 400) {
                return json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
            }
    ...
    * Returns a playlist
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/v2/playlist/$$serviceParam/$$playlistId", method: HttpMethod::GET));
            $statusCode = $response->getStatusCode();
            if ($statusCode >= 200 && $statusCode < 400) {
                return json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
            }
    ...
    * Updates a playlist
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/v2/playlist/$$serviceParam/$$playlistId", method: HttpMethod::PUT, body: $request));
            $statusCode = $response->getStatusCode();
            if ($statusCode >= 200 && $statusCode < 400) {
                return json_decode($response->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
            }
    ...
    * Deletes a playlist
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/v2/playlist/$$serviceParam/$$playlistId", method: HttpMethod::DELETE));
            $statusCode = $response->getStatusCode();
            if ($statusCode >= 200 && $statusCode < 400) {
                return;
            }

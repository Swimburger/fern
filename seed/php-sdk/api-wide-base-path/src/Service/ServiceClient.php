...
class ServiceClient
{
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/test/$$pathParam/$$serviceParam/$$endpointParam/$$resourceParam", method: HttpMethod::POST));

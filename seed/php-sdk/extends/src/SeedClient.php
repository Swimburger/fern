...
class SeedClient
{
    ...
    {
        try {
            $response = $this->client->sendRequest(new JsonApiRequest(baseUrl: $this->options['baseUrl'] ?? '', path: "/extends/extended-inline-request-body", method: HttpMethod::POST, body: $request));
